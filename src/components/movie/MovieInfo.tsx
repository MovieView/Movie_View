...
import { fetchMovie, fetchMovieCredits } from '@/utils/movieApi';
        ...
        <div className='col-span-1 mb-4 lg:mb-0'>
          <Image
            className={ imageLoaded 
              ? 'w-3/4 lg:w-full max-w-sm lg:h-[26rem] h-96 rounded-lg shadow-lg animate-pulse flex space-x-4 bg-gray-300'
